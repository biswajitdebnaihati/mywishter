...
public class FriendSearchResult extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.friend_search_lay, container, false);
    ...
    public class RequestAdapter extends RecyclerView.Adapter<RequestAdapter.Hold>{
        ...
        public RequestAdapter.Hold onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.friend_search_row, parent, false);
            return new Hold(v);
        }
